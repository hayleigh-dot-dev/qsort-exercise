...
--   Html.section (A.class "container mx-auto bg-gray-200 my-4 px-10 py-4 rounded-lg" :: attrs)
--     [ Html.h2 [ A.class "border-b-2 border-black mb-2 text-2xl text-bold" ]
--       [ Html.text title ]
--     , Html.p [ A.class "mb-4 text-justify" ]
--       [ Html.text description ]
--     , Html.div [ A.class "container" ] children
--     ]

-- full : String -> String -> List (Attribute msg) -> List (Html msg) -> Html msg
-- full title description attrs children =
--   Html.section (A.class "w-screen bg-gray-200 my-4 px-10 py-4 rounded-lg" :: attrs)
--     [ Html.h2 [ A.class "border-b-2 border-black mb-2 text-2xl text-bold" ]
--       [ Html.text title ]
--     , Html.p [ A.class "mb-4 text-justify" ]
--       [ Html.text description ]
